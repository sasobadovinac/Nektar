...
<test>
    ...
    <metrics>
        ...
        <metric type="regex" id="2">
            ...
            <matches>
                <match>
                    <field variable="u0S" tolerance="5E-7">0.00011547</field>
                </match>
                <match>
                    <field variable="v0S" tolerance="5E-7">0.00011547</field>
                </match>
                <match>
                    <field variable="u0R" tolerance="5E-9">1.03161e-05</field>
                </match>
                <match>
                    <field variable="v0R" tolerance="5E-9">1.03161e-05</field>
                </match>
            </matches>
        </metric>
        <metric type="regex" id="3">
            ...
            <matches>
                <match>
                    <field variable="u1S" tolerance="5E-8">1.1547e-05</field>
                </match>
                <match>
                    <field variable="v1S" tolerance="5E-8">1.1547e-05</field>
                </match>
                <match>
