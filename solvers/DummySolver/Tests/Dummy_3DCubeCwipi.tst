    ...
    <metrics>
        ...
        <metric type="regex" id="1">
            ...
            <matches>
                ...
                <match>
                    <field variable="F_0_u1R" tolerance="5E-4">22.1497</field>
                </match>
                <match>
                    <field variable="F_0_v1R" tolerance="5E-4">26.4196</field>
                </match>
            </matches>
        </metric>
        <metric type="regex" id="2">
            ...
            <matches>
                <match>
                    <field variable="u0S" tolerance="5E-8">0.00011547</field>
                </match>
                <match>
                    <field variable="v0S" tolerance="5E-8">0.00011547</field>
                </match>
                <match>
                    <field variable="u0R" tolerance="5E-10">1.03161e-05</field>
                </match>
                <match>
                    <field variable="v0R" tolerance="5E-10">1.03161e-05</field>
                </match>
            </matches>
        </metric>
        <metric type="regex" id="3">
            ...
            <matches>
                <match>
                    <field variable="u1S" tolerance="5E-4">1.1547e-05</field>
                </match>
                <match>
                    <field variable="v1S" tolerance="5E-4">1.1547e-05</field>
                </match>
                <match>
                    <field variable="u1R" tolerance="5E-10">5.15227e-05</field>
                </match>
                <match>
                    <field variable="v1R" tolerance="5E-10">5.15227e-05</field>
                </match>
            </matches>
        </metric>
    </metrics>
