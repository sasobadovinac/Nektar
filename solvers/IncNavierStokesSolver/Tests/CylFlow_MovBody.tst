...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="w" tolerance="1e-12">0.00652058</value>
            <value variable="p" tolerance="1e-12">167.909</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-12">1.44442</value>
            <value variable="v" tolerance="1e-12">0.670928</value>
            <value variable="w" tolerance="1e-12">0.00442894</value>
            <value variable="p" tolerance="1e-12">5.69647</value>
        </metric>
    </metrics>
</test>
