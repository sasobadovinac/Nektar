...
<test>
    <description>Channel Flow P=3 with convective link outflow BC and Implicit scheme</description>
    <executable>IncNavierStokesSolver</executable>
    <parameters>ChanFlow_m3_ConOBC.xml -I SolverType=VCSImplicit</parameters>
    <files>
