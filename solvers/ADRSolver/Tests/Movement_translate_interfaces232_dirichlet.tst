...
<test>
    <description>2D advection with 3 zones and 2 non-conformal interfaces with periodic BCs with central zone translating</description>
    ...
    <metrics>
        ...
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-9">2.30174e-10</value>
        </metric>
    </metrics>
</test>
