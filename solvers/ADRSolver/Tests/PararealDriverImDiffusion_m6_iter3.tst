...
<test>
    ...
    <files>
        ...
        <file description="Session File"> PararealDriverImDiffusion_m6_iter3_coarseSolver.xml </file>
    </files>
    <metrics>
        <metric type="L2" id="1">
            <value variable="u" tolerance="5e-09">0.000226570</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="u" tolerance="5e-09">0.000582955</value>
        </metric>
    </metrics>
</test>
