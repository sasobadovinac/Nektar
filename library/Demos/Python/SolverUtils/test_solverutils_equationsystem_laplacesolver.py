...
class TestEquationSystemLaplaceSolver(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        TestEquationSystemLaplaceSolver.adrsolver_plugin =  \
    ...
    def testEquationSystemCreateLaplaceSolver(self):
        self.session_name = ["test_solverutils_equationsystem_laplacesolver.py",\
