...
struct HelmholtzTemplate : public Helmholtz,
                          public Helper<LibUtilities::ShapeTypeDimMap[SHAPE_TYPE], DEFORMED>
{
      ...
      Helper<LibUtilities::ShapeTypeDimMap[SHAPE_TYPE], DEFORMED>(basis, nElmt)
    {
        ...
        else if( DIM == 3 )
        {
...
#if defined(SHAPE_TYPE_TET) || defined(SHAPE_TYPE_PRISM) || defined(SHAPE_TYPE_PYR)
            const auto nq0 = m_basis[0]->GetNumPoints();
            const auto nq1 = m_basis[1]->GetNumPoints();
            ...
            GetHelmholtz3DHalfSpace<SHAPE_TYPE>(nq0, nq1, nq2, z0, z1, z2,
                                                m_h0, m_h1, m_h2, m_h3);
#endif
        }
    }
    ...
    static std::shared_ptr<Operator> Create(
        ...
        int nElmt)
    {
      return std::make_shared<HelmholtzTemplate<SHAPE_TYPE, DEFORMED>>(basis, nElmt);
    }
...
#include "SwitchNodesPoints.h"
                          ...
                          Array<OneD,       NekDouble>& output)
    {
        ...
        std::vector<vec_t, allocator<vec_t>> wsp0(wsp0Size), tmpIn(m_nmTot), tmpOut(m_nmTot);
        ...
        for (int e = 0; e < this->m_nBlocks; e++)
        {
            ...
            BwdTrans2DKernel<SHAPE_TYPE>(
                             ...
                             tmpIn, this->m_bdata[0], this->m_bdata[1], wsp0, bwd);
            ...
            IProduct2DKernel<SHAPE_TYPE, true, false, DEFORMED>(
                             ...
                             this->m_w[1], jac_ptr, wsp0, tmpOut, m_lambda);
            ...
            Helmholtz2DKernel<SHAPE_TYPE, DEFORMED>(
                              nq0, nq1,
                              this->m_isConstVarDiff, this->m_constVarDiff,
                              this->m_isVarDiff, this->m_varD00, this->m_varD01, this->m_varD11,
                              df_ptr, this->m_h0, this->m_h1, bwd, deriv0, deriv1);
            ...
            IProduct2DKernel<SHAPE_TYPE, false, true, DEFORMED>(
                             ...
                             this->m_w[1], jac_ptr, wsp0, tmpOut);
                          ...
                          Array<OneD,       NekDouble>& output)
    {
        ...
        std::vector<vec_t, allocator<vec_t>> deriv0(nqTot), deriv1(nqTot), deriv2(nqTot);
        ...
        for (int e = 0; e < this->m_nBlocks; e++)
        {
            ...
            // // Step 2: inner product for mass matrix operation
            IProduct3DKernel<SHAPE_TYPE, true, false, DEFORMED>(nm0, nm1, nm2, nq0, nq1, nq2,
                             correct,
                             bwd, this->m_bdata[0], this->m_bdata[1], this->m_bdata[2],
                             this->m_w[0], this->m_w[1], this->m_w[2], jac_ptr,
                             wsp0, wsp1, wsp2, tmpOut, m_lambda);
            ...
            Helmholtz3DKernel<SHAPE_TYPE, DEFORMED>(
                              ...
                              this->m_isConstVarDiff, this->m_constVarDiff,
                              this->m_isVarDiff,
                              this->m_varD00, this->m_varD01, this->m_varD11,
                              this->m_varD02, this->m_varD12, this->m_varD22,
                              df_ptr, this->m_h0, this->m_h1, this->m_h2, this->m_h3,
                              deriv0, deriv1, deriv2);
