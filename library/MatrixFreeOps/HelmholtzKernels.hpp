...
NEK_FORCE_INLINE static void HelmholtzTriKernel(
    ...
    const Array<OneD, NekDouble>& constVarDiff,
    const bool isVarDiff,
    const Array<OneD, NekDouble> & varD00,
    const Array<OneD, NekDouble> & varD01,
    const Array<OneD, NekDouble> & varD11,
    const vec_t* df_ptr,
...
NEK_FORCE_INLINE static void HelmholtzHexKernel(
    ...
    const Array<OneD, NekDouble> & varD01,
    const Array<OneD, NekDouble> & varD11,
    const Array<OneD, NekDouble> & varD02,
    const Array<OneD, NekDouble> & varD12,
    const Array<OneD, NekDouble> & varD22,
    const vec_t* df_ptr,
          std::vector<vec_t, allocator<vec_t>>& deriv0,
          std::vector<vec_t, allocator<vec_t>>& deriv1,
...
{
#if defined(SHAPE_TYPE_TRI)
    HelmholtzTriKernel<DEFORMED>(nq0, nq1,
                       isConstVarDiff, constVarDiff,
                       isVarDiff, varD00, varD01, varD11,
                       df_ptr, h0, h1, bwd, deriv0, deriv1);
#elif defined(SHAPE_TYPE_QUAD)
    boost::ignore_unused(h0, h1);
    HelmholtzQuadKernel<DEFORMED>(nq0, nq1,
                        isConstVarDiff, constVarDiff,
                        isVarDiff, varD00, varD01, varD11,
          ...
          std::vector<vec_t, allocator<vec_t>>& deriv2)
{
    ...
    HelmholtzHexKernel<DEFORMED>(nq0, nq1, nq2,
                       isConstVarDiff, constVarDiff, isVarDiff,
                       varD00, varD01, varD11, varD02, varD12, varD22,
                       df_ptr, deriv0, deriv1, deriv2);
#elif defined(SHAPE_TYPE_TET)
    HelmholtzTetKernel<DEFORMED>(nq0, nq1, nq2,
                       isConstVarDiff, constVarDiff, isVarDiff,
                       varD00, varD01, varD11, varD02, varD12, varD22,
                       df_ptr, h0, h1, h2, h3, deriv0, deriv1, deriv2);
#elif defined(SHAPE_TYPE_PRISM)
    boost::ignore_unused(h2, h3);
    HelmholtzPrismKernel<DEFORMED>(nq0, nq1, nq2,
                         isConstVarDiff, constVarDiff, isVarDiff,
                         varD00, varD01, varD11, varD02, varD12, varD22,
                         df_ptr, h0, h1, deriv0, deriv1, deriv2);
#elif defined(SHAPE_TYPE_PYR)
    boost::ignore_unused(h3);
    HelmholtzPyrKernel<DEFORMED>(nq0, nq1, nq2,
                       isConstVarDiff, constVarDiff, isVarDiff,
                       varD00, varD01, varD11, varD02, varD12, varD22,
                       df_ptr, h0, h1, h2, deriv0, deriv1, deriv2);
#endif
}
