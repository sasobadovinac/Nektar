...
{
#if defined(SHAPE_TYPE_SEG)
    IProductWRTDerivBaseSegKernel<DEFORMED>(nq0, ndf,
          ...
          std::vector<vec_t, allocator<vec_t>>& tmp1)
{
    ...
    IProductWRTDerivBaseTriKernel<DEFORMED>(nq0, nq1,
                                  indim,
                                  df_ptr, df_tmp, Z0, Z1,
                                  tmpIn, tmp0, tmp1);
#elif defined(SHAPE_TYPE_QUAD)
    boost::ignore_unused(Z0, Z1);
    IProductWRTDerivBaseQuadKernel<DEFORMED>(nq0, nq1,
                                   indim,
                                   df_ptr, df_tmp,
                                   tmpIn, tmp0, tmp1);
#endif
          ...
          std::vector<vec_t, allocator<vec_t>>& tmp2)
{
    ...
    IProductWRTDerivBaseHexKernel<DEFORMED>(nq0, nq1, nq2,
                                            df_ptr,
                                            tmpIn0, tmpIn1, tmpIn2,
                                            tmp0, tmp1, tmp2);
#elif defined(SHAPE_TYPE_TET)
    IProductWRTDerivBaseTetKernel<DEFORMED>(nq0, nq1, nq2,
                                            df_ptr, Z0, Z1, Z2,
                                            tmpIn0, tmpIn1, tmpIn2,
                                            tmp0, tmp1, tmp2);
#elif defined(SHAPE_TYPE_PRISM)
    boost::ignore_unused(Z1);
    IProductWRTDerivBasePrismKernel<DEFORMED>(nq0, nq1, nq2,
                                              df_ptr, Z0, Z2,
                                              tmpIn0, tmpIn1, tmpIn2,
                                              tmp0, tmp1, tmp2);
#elif defined(SHAPE_TYPE_PYR)
    IProductWRTDerivBasePyrKernel<DEFORMED>(nq0, nq1, nq2,
                                            df_ptr, Z0, Z1, Z2,
                                            tmpIn0, tmpIn1, tmpIn2,
                                            tmp0, tmp1, tmp2);
#endif
