...
namespace Polylib {
  ...
  */
  ...
  LIB_UTILITIES_EXPORT void   Dgj     (double *, const double *, const int, const double, 
				       const double);
  LIB_UTILITIES_EXPORT void   Dgj2     (double *, const double *, const int, const int, const double, 
					const double);
  ...
  LIB_UTILITIES_EXPORT void jacobfdd  (const int, const double *, double *, double *,double *,
				       const int ,
				       const double, const double);
