...
fluctuations.  Finally, it is necessary to specify the base flow using the following functions:
...
By default, the right hand sides $\overline{c}^2 q_c$ and $U_i$ are zero and has to be specified by an appropriate forcing.
