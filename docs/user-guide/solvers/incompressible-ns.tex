...
For linear problems, Discrete Fourier Transform (DFT) is applied to reach the solution of Tensioned Euler Beam, whereas for geometrically nonlinear problems, a third-party open source code, named as 'SHARPy', which is developed for Simulation of High-Aspect-Ratio Planes in aeroelastics, can be employed for the nonlinear dynamic solutions of flexible bodies.  

An example of \inltt{SOLVERINFO} for 'DFT' is given as follows:
\begin{lstlisting}[style=XMLStyle]
<SOLVERINFO>
	<I PROPERTY="StructDynSolver" VALUE="DFT"/>
	<I PROPERTY="SupportType"     VALUE="PINNED-PINNED"/>
</SOLVERINFO>
\end{lstlisting}
 
An example of \inltt{SOLVERINFO} for 'SHARPy' is given as follows:
\begin{lstlisting}[style=XMLStyle]
<SOLVERINFO>
	<I PROPERTY="StructDynSolver"      VALUE="SHARPy"/>
    <I PROPERTY="BeamBConds"           VALUE="SS"/>
	<I PROPERTY="IsBeamGravity" 	   VALUE="TRUE"/>
    <I PROPERTY="BeamFollowerForce"    VALUE="True"/>
    <I PROPERTY="BeamFollowerForceRig" VALUE="True"/>
    <I PROPERTY="BeamPrintInfo"        VALUE="False"/>
</SOLVERINFO>
\end{lstlisting}

The parameters to describe the structural properties in two different solvers of 'DFT' and 'SHARPy' are a little bit different, for example:
...
\begin{lstlisting}[style=XMLStyle]
<PARAMETERS>
    <P> BeamLength    = 10*PI   </P> <!--SHARPy-->
    <P> BeamI         = PI/64.0 </P> <!--SHARPy-->
    <P> BeamA         = PI/4.0  </P> <!--SHARPy-->
    <P> BeamE         = 1.1e4   </P> <!--SHARPy-->
    <P> BeamMu        = 0.3     </P> <!--SHARPy-->
    <P> BeamRho       = 6       </P> <!--SHARPy-->
    <P> BeamDT        = 0.005   </P> <!--SHARPy-->
    <P> BeamNumNodesElem = 2    </P> <!--SHARPy-->
    <P> BeamNumElems  = 64      </P> <!--SHARPy-->
    <P> BeamDiameter  = 1.0     </P> <!--SHARPy-->
    <P> Velocity\_Infinity = 1.0</P> <!--SHARPy-->
    <P> Density\_Fluid = 1000   </P> <!--SHARPy-->
</PARAMETERS>
\end{lstlisting}
