...
\end{lstlisting}
%
Both the Gmsh and Nektar++ output modules support an \inltt{order}
...
With NekMesh you can also turn on the option \inltt{useDefExpansions} to write out the Default Expansion List to make visualising and the troubleshooting of meshes easier:
%
\begin{lstlisting}[style=BashInputStyle]
NekMesh Mesh.msh output.xml:xml:useDefExpansions=true
\end{lstlisting}
%
