...
Filter \inltt{OffsetPhase} computes the instantaneous phase of the action potential using a time delay-embedding technique \cite{iyer2001}:\\
\begin{equation*}
...
Filter \inltt{HilbertFFTPhase} computes the instantaneous phase of the action 
