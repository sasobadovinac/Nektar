...
<test>
    ...
    <parameters>varopti_cube_sphere.msh varopti_cube_sphere-out.xml:xml:useDefExpansions=true:test -v -m varopti:hyperelastic:numthreads=2:maxiter=5:nq=4</parameters>
    <files>
