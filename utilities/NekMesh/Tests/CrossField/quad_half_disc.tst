...
<test>
    ...
    <parameters>-v -m bl:surf=4,7:surf2=2,10:layers=7:r=1.0 -m bl:surf=4,3,2:surf2=6,11,8:layers=5:r=1.0 -m bl:surf=5,1,9:surf2=7,3,10:layers=3:r=1.0 quad_half_disc.mcf quad_half_disc.xml</parameters>
    <files>
