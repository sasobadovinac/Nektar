...
<test>
    ...
    <parameters> -f -e  -m interppoints:cp=0,0.5:plane=10,9,0,0,0,1,1,0,1,1,1,0,0,1:fromxml=chan3DH1D.xml:fromfld=chan3DH1D_zVariation.fld chan3DH1D_plane.dat</parameters>
    <files>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="Cp0" tolerance="1e-6">3.50117</value>
        </metric>
    </metrics>
</test>